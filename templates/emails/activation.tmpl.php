...
<div class="info-message">
    ...
    <p>Vous avez été inscrit sur le réseau social <strong><?=WEBSITE_NAME?></strong> des <strong>Développeurs</strong>
...
<a href="<?=WEBSITE_URL.'/Reseau_social/activation.php?p='.$pseudo.'&amp;token='.$token?>" title="Activer">
